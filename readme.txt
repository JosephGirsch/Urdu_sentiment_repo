...
This repository contains the code and documentation for a Sentiment Analysis Case Study. The goal of this project is to automatically identify the sentiment expressed in text data, with a focus on under-resourced languages. The sentiment classes are Positive, Negative, and Neutral.
